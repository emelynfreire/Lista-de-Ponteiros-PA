/*
Sim, estão sendo obtidas as respostas esperadas. Porém, os endereços retornarão valores hexadecimais em que cada endereço poderá
vir diferente referente a sua alocação na memória do computador.
